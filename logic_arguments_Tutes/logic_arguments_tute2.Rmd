...
*****  
>Most claims that Donald Trump makes about himself are false. Donald Trump said, "I have normal-sized fingers". Therefore Donald Trump does not have normal-sized fingers.
...
*****  
### Valid is to Strong as Sound is to Cogent  

For *inductive* arguments, the term for logically consistent is **strong** rather than **valid**- "valid" is used only for deductive arguments. 
The counterpart to the term *sound* (in deduction, used for both the premises being true and the argument logically consistent) is "cogent" for induction. 
For an inductive argument to be cogent, both the premises must be true and the argument must be strong.

26. Returning to the Trump argument, is it *strong*? ____________
<!-- Yes -->
27. Is it *cogent*? ___________
<!-- Not sure -->
...
29. Is the above *strong*? ____________
<!-- Yes -->
30. Is it *cogent*? ___________
<!-- Yes  -->
...
31. Is the conclusion **strong**? _________________  
...
-->
<BR>
32. Is the conclusion cogent? __________________
<!--No, because it isn't strong. To be cogent, the argument must be strong AND the premises must be true. 
<!-- Tell the students that not only is the argument unsound, but also the conclusion happens to be false.
...
There are other explanations of the car being silent, so the argument is not sound.

However while the argument as stated is deductive, in the real world few cause->effect relationships are not 1-to-1. For example, while the battery being dead is one cause of a car being silent, there are other possible causes. 

The writer of the argument probably is aware of there being other possible causes of the car being silent, but simply thinks they are much more unlikely than the possibility that the battery is dead. In other words, the writer may actually be reasoning inductively. Language is often used very messily. Humans!

Rewrite the argument to make it clear it is inductive:
...
42. Is the argument strong? NO / YES 
<!--Yes, the logic follows -->
43. Do you think the argument is cogent? NO / YES
<!--Yes, from what I know about cars-->
...
– Pope Leo XIII, Rerum Novarum
  ...
  c. Public administration must duly and solicitously provide for the welfare and comfort of the working classes.   d. The law of justice will be violated which ordains that each man shall have his due. 
...
<!--D. The word “since” is the indicator word showing a premise, and immediately preceding the “since” is the conclusion. The first sentence supports this conclusion by pointing out how Hegel is interpreted in varying ways.-->
...
Circle the main conclusion.
<!--  there are subconclusions, but arguably the final conclusion is marked by the indicator “so.”, 
...
Lily is asking **why** she's all over the news, but in real-world conversation it can be easy to forget or mistake the original question, as Beth has perhaps done.
...
**Jess**: In America, the accident rate dropped when the speed limit was reduced to 55 mph (89 kph) in the late 1970's, and it has increased substantially since the speed limit was returned to 65 mph (105 kph).

**Mark**: Many people will drive at 110 kph whether or not the legal limit is 100 kph.

Did Jess effectively rebut Mark's claims, assuming that Jess's statement was factually correct?  
<!-- Rebutted the claim of safety. Although she didn't say how much exactly the accident rate dropped and increased. Maybe the rate in both cases is low enough to be considered safe?-->

<BR>
_________________________________________________________________________

<BR>
Did Mark effectively rebut Jess' point?  
<BR> _________________________________________________________________________  
<BR>
Did Mark effectively defend his initial claim?  
<!--Well he makes what may be a valid point, and at first you may think, he scored!
But when you examine the connection to his initial claim, you realize his position has become a bit fraught.
Initially he was making one argument for raising the speed limit, and now he is making a completely different one. And it's not clear at this point whether it is a good one.
...
<!--There isn't enough here to fairly evaluate Chen's full position.
Unfortunately, this is as far as people in a real-world argument usually get.-->
<BR>
___________________________________________________________________________________

<BR>
This is about as far as most arguments get in the media. In a debate on television, people usually only get to say two or three things to each other. But it’s impossible to settle most issues in such a short time. If we want to be sure we know the truth about something, we need patience and dedication to the issue.
