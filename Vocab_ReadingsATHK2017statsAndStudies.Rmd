...
* To find some definitions of the terms in this document, open [`Vocab_ReadingsATHK2017statsAndStudies.Rmd`](https://raw.githubusercontent.com/alexholcombe/teachingATHK/master/Vocab_ReadingsATHK2017statsAndStudies.Rmd) and you'll see definitions in the comments, indicated by `<!--- comment text -->`. 
