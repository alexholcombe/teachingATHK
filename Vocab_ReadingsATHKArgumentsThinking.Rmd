...
* <abbr title="Stating what lots of other people think as a reason to believe something">Ad populum</abbr>
...
* These terms are all closely related to each other:
  * <abbr title="the tendency to search for, interpret, favor, and recall information in a way that confirms or supports one's prior beliefs or values.">Confirmation bias</abbr>
  * <abbr title="We focus on fortifying our case and shooting down the other party’s points. Changing your mind feels like surrendering or being defeated.">Soldier mind</abbr>
  * My-side bias
