...
Week 9 tutorial: Necessary and sufficient, if-then, and only-if [explained by Khan academy](https://www.khanacademy.org/test-prep/lsat/lsat-lessons/logic-toolbox-new/a/logic-toolbox--article--if-x-then-y--sufficiency-and-necessity)
...
Week 11 tutorial: Arguments in the wild. Identifying conclusions and premises in real-world text and conversations.

## Important terminological note

Philosophers typically use "valid" and "sound" for describing deductive arguments, in this class we instead use the terms "suppositionally inescapable" and "inescapable" because they are easier to understand. On quizzes and tests, you will only be tested on these terms.

Philosophers typically use "strong" and "cogent" for describing *inductive* arguments, but in this class we use the terms "suppositionally solid" and "solid" because they are easier to understand. On quizzes and tests, you will only be tested on these terms.
...
* *Think Critically* by Facione, Chapter 6: Evaluate the Credibility of Claims and Sources, available from the eReserve link at left of Canvas

<!-- Critical Thinking, by Paul and Elder -->

* [Arguments overview](https://raw.githubusercontent.com/alexholcombe/teachingATHK/master/ArgumentsOverview.docx)
...
One that varies with the variable whose effect one is interested in and thus obscures their true relationship
...
* Suppositionally inescapable (also known as "valid")
