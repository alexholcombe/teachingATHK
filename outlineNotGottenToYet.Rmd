...
* Why does the news have lots of false positives? <!--slides 168 to 180-->
  * Excess of statistical comparisons (already talked about this in Week 9)  
  * Publication bias  -->
...
<!-- "confirmationBias" Keynote -->

* Wason card selection task, as an argument/syllogism  <!-- 18 slides -->
  * [Confirmation bias](https://www.verywellmind.com/what-is-a-confirmation-bias-2795024)
  * Cheater detection framing
  * Self-explanation
  * Group discussion
* Mindset again: Biased evaluation - confirmation or "my-side" bias  <!-- 7 slides -->
