...
(@) An experiment would be important to settle the issue.
(@) An experiment is possible / feasible / impossible.
(@) Whether the most straightforward relevant evidence would be a correlation or some other sort of evidence.
...
-->
1. Driving a car is much more dangerous than flying in a commercial airliner
...
flying airliners (2004): 19.7 fatalities per million hours
driving: .588 fatalities per million hours
On this basis, flying has 21 times the number of fatal accidents and 33.5 times the number of fatalities per hour of operation. http://www.meretrix.com/~harry/flying/notes/safetyvsdriving.html
-->
3. Crystal meth (ice) is the drug of choice on the streets today.
...
4. Humanities classes at the University of Sydney are marked more leniently than science classes.
...
-->
5. Background: Male drivers have significantly more accidents than female drivers. As a result, insurance companies in many countries charge males more. Statement to evaluate: Males are worse drivers than females.
