...
date: "week of 30 April, 2018"
---
<!-- TUTORS: Students could work on these in pairs, and may want to google things
-->

### Learning Outcomes
Understand the following:

An **explanatory variable** is one that may explain differences in a dependent variable (DV). For example, a predictor variable in regression analysis is an explanatory variable.

**Spurious correlation** - correlation between X and Y that one might think is due to X causing Y or Y causing X, but isn't 

Gain experience recognising and thinking of **Confounds** or **confounding variables**.  

### Study elements

Term | Definition | Seat belt - airplane | Murder - ice cream relationship | Self-quiz - exam relationship | Liberals - Darks relationship |
----------- | ----------- | ------------- | ------------- | ------------- | ------------- |
Outcome measure or dependent variable (DV)  | The behavior or outcome that is measured. It is expected to change as a result of changes in the IV. |  | | | |
Explanatory variable | Changes in the explanatory variable may be related to changes in the DV. |  | | | |
Confound (Bruce mentioned "omitted variables" in the context of linear regression, which can act like a confound) | Variable that changes with the explanatory variable. The DV could be affected by both the explanatory variable and/or the confound, so we cannot conclude that the DV was affected by (**was caused by**) the explanatory variable. |  | | | |

<!--STUDENTS The word "confound" is usually used for experimental studies, while "omitted variable" is usually used for non-experimental (e.g., correlational) studies STUDENTS-->
...
![](familyCircusCorrelatn.jpg) <BR><BR>

The boy in the cartoon has noticed a correlation. According to the line of thinking articulated by the boy, what is the outcome measure?
____________________________________________ <!--STUDENTS bumpiness STUDENTS-->

What is the explanatory variable, in his line of thinking?
____________________________________________ <!--STUDENTS Turning on the seatbelt STUDENTS-->
...
Under the third-factor explanation, what could the third factor be and what might its relationship be to the other variables? 
...
As shown in the graph below (made-up data), murder rates and ice cream sales are highly positively correlated. That is, days with higher murder rates also have higher sales of ice cream. 
...
<BR>
<!--STUDENTS * There is a third variable — a **confound** — which causes the increase in BOTH ice cream sales AND murder rates.
     + temperature 
STUDENTS-->
...
**Confound**: Consider a relationship between two variables, X and Y, with higher levels of X associated with higher level of Y. A confounding variable is an extraneous variable that is statistically related to (or correlated with) the X. This means that as X changes, the confounding variable changes along with it. Above, the confounds came up when you were asked about a **third factor** (not all third factors are confounds).

### Experiments to infer causation

For the school science fair, a year 6 student is interested in the effect of ultraviolet (UV) light on plant growth. 

![](dataCollectionScienceProj.jpg) She gets a packet of pea plant seeds and distributes them randomly among fifty pots. She puts twenty-five of the pots under an ultraviolet light and twenty-five under a broad-spectrum halogen bulb, and a month later finds that all twenty-five of the ultraviolet pots' plants are higher.

What is the dependent variable? ____________________________

What is the explanatory variable? ____________________________

Is this study an experiment or a correlational study? ____________________________

<!-- DELETE THIS NEXT YEAR-->
Can you think of any third factor that might explain the difference in plant height?  _________________________________
...
In perfect experiments, there is no variable that systematically changes with the explanatory variable besides the explanatory variable (and its effects) itself. This is why experiments provide the most secure way to determine whether an explanatory variable is truly affecting the dependent variable.

The explanatory variable in an experiment is called the **independent variable**, because if the experiment is done perfectly, there is no confounding variable that changes with it.

While an ideal experiment will not have a confound, there may still be third factors, e.g. the seeds that happened to end up in the UV light pots may have been stronger in some way. This is why statistics (p-values) should be calculated, to assess whether the difference in height could have occurred due to random factors.
...
On the basis of this evidence, the lecturer says to the students, "You should complete the self-quiz because it will  improve your chances of getting a good exam grade."
...
<!--STUDENTS Students who are motivated enough to do the self-quiz are also motivated enough to study for the exam. **Motivation** may be a confound.
...
<!--STUDENTS Motivation causes more self-quiz completions.
...
<!--STUDENTS Maybe Liberals take courses that are easier. Maybe Liberals cheat more. Maybe tutors or lecturers discriminate against Dark Alternatives STUDENTS-->
...
2. Humanities classes at the University of Sydney are marked more leniently than science classes.
...
-->
3. Background: Male drivers have significantly more accidents than female drivers. As a result, insurance companies in many countries charge males more. Statement to evaluate: Males are worse drivers than females.
