...
The following plot shows the number of confirmed cases of COVID-19 infection in the state of New South Wales in Australia, for each day since the 4th of March.
...
An unknown person had yet another idea:
...
While that is unlikely, it makes the point that there are typically many differences between two groups of countries, only some of which you are likely to think of.
...
This is important to consider, because although the scrawled-on plot by itself provides only very weak evidence that masks are effective, reasons to believe a claim can also come from other places.

During an exponentially-growing pandemic, one doesn't have time to wait for strong evidence. Wearing masks is a very plausible cause of reduced transmission, so it may be a good policy to adopt even if empirical evidence for its effectiveness is weak.
