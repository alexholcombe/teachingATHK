...
If the number of cases does grow by the same percentage each day, this is referred to as "exponential growth". On average each person infected may pass a disease on to a certain number of others. Thus the change in cases reflects the number who are already infected, yielding a percentage increase rather than a constant.
