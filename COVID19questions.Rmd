...
From twitter, here are some responses to the person who tweeted the scrawled-on plot.
...
```{r multivariate}
question("What approach might be used to try to estimate the effects of mask wearing and temperature?",
