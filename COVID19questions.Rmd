...
h<-ggplot( data = NSW, aes( date, cases )) + geom_point() + theme_bw() + ylab("Confirmed cases in NSW") + scale_x_date(date_minor_breaks=("1 days")) + ylim(0,15000) + xlim(as.Date(c(NA, endDate))) +
...
The above plot shows that with a logarithmic vertical axis, any particular daily growth rate (multiplication by a particular factor) results in a straight line of corresponding slope.
