...
* (this document!). To find some definitions of the terms, open the  `Vocab_ReadingsATHK2017ArgumentsThinking.Rmd` and you'll see definitions in the comments, indicated by `<!--- comment text -->`. 
Quiz yourself with the version that doesn't show the definition, and subsequently check the definition in the .Rmd version to see if you got it right.  
