---
title: "ATHK Weeks 6 to 10 vocabulary and readings"
...
* "Outcome variable" is another term for dependent variable in an experiment, or variable one is interested in explaining in an observational study
* "Explanatory variable" is another term for the independent variable in an experiment, or the variable one is hoping explains another in an observational study
...
-->
* [Nuisance variable](https://dictionary.apa.org/nuisance-variable) or noise variable versus confound (BE CAREFUL, some sources online give a different definition)
...
# Logic and arguments: Weeks 9 and 10
...
* [Comic](https://thenib.com/repeat-after-me/) about p-hacking and publication bias and the "replication crisis" 
